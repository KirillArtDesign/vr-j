 ...
 */
 ...
 //bugs
  		update_option('clearfy_license_verify', time() + 60 * 60 * 24 * 30 * 12);
        update_option('clearfy_license_key', 'valid');
        update_option('license_verify', time() + 60 * 60 * 24 * 30 * 12 );
...
class Clearfy_Plugin_Admin {
    ...
    public function license_verify() {
        ...
        if ( ! empty( $license_key ) && ( time() > $license_verify || empty( $license_verify ) ) ) {
            ...
            if ( is_wp_error( $response ) ) {
                $this->api_url = str_replace("https", "http", $this->api_url);
        ...
        <div class="wrap">
            ...
            <div class="clearfy-changelog">
                <div class="clearfy-changelog__item">
                    <strong class="clearfy-changelog__version" title="13.09.2017">3.1.0</strong>
                    <ul>
                        <li>Добавлена: возможность удалить jquery-migrate.min.js</li>
                        <li>Добавлена: возможность удалить версию ?ver= у файлов стилей и скриптов</li>
                        <li>Обновлен внешний вид</li>
                    </ul>
                </div>
                <div class="clearfy-changelog__item">
                    <strong class="clearfy-changelog__version" title="13.09.2017">3.0.1</strong>
                    <ul>
                        <li>обновление до Pro версии, смена серверов обновления</li>
                    </ul>
                </div>
                <div class="clearfy-changelog__item">
                    <strong class="clearfy-changelog__version" title="13.09.2017">3.0.0</strong>
                    <ul>
                        <li>повышен приоритет для last modified wprocket</li>
                        <li>минификатор теперь не удаляет пустой атрибут value</li>
                    </ul>
                </div>
                <div class="clearfy-changelog__item">
                    <strong class="clearfy-changelog__version" title="31.07.2017">1.0.8</strong>
                    <ul>
                        <li>Добавлен: редирект HTTP на HTTPS</li>
                        <li>Доработано: удаление &lt;image:image&gt; из XML карты Yoast</li>
                        <li>Исправлено: удаление itemscope="" при включенной минификации</li>
                        <li>Мелкие улучшения ф-ционала</li>
                    </ul>
                </div>
                <div class="clearfy-changelog__item">
    ...
    public function admin_page_display() {
        ...
        <div class="wrap wpshop clearfy js-clearfy">
            ...
            <div class="wpshop-cols">
                ...
                <div class="pseudo-button js-clearfy-enable">Включить все, что возможно</div>
                ...
                <div class="wpshop-col-left">
                    ...
                    <form method="post" action="options.php" class="js-clearfy-form">
                        ...
                        <h2 class="wpshop-tab-wrapper js-wpshop-tab-wrapper">
							...
							<a class="wpshop-tab" id="tab-clearfy_double" href="#clearfy_double">Дубли</a>
                        ...
                        <div id="clearfy_general" class="wpshop-tab-in js-wpshop-tab-item active">
                            ...
                            <div class="option-field-header">Инструкция</div>
                            ...
                            <div class="option-field-header">Команда WPShop.ru</div>
                        ...
                        <div id="clearfy_clear" class="wpshop-tab-in js-wpshop-tab-item">
                            <div class="option-field-header">Чистка кода</div>

                            <div class="option-field">
                                <label class="option-field-label" for="disable_json_rest_api">
                                    Отключить JSON REST API
                                    <div class="clearfy-recommend">Рекомендовано</div>
                                </label>
                            ...
                            <div class="option-field">
                                ...
                                <div class="option-field-body">
                                    ...
                                    <p class="description">Файл jquery-migrate.min.js требуется для старых скриптов jQuery до версии 1.9.х. Сейчас необходимости использовать этот файл практически нет.</p>
                                    <p class="description"><strong>Clearfy:</strong> Удаляет подключение jquery-migrate.min.js из <code>&lt;head&gt;</code></p>
                                    <p class="description"><span class="dashicons dashicons-warning wpshop-warning-color"></span> Проверьте работу сайта после установки параметра</p>
                                </div>
                            </div><!--.option-field-->
                            ...
                            <div class="option-field">
                                <label class="option-field-label" for="remove_shortlink_link">
                                    Удалить короткую ссылку <code>/?p=</code>
                                    <div class="clearfy-recommend">Рекомендовано</div>
                                </label>
                                <div class="option-field-body">
                            ...
                            <div class="option-field auto-enable-false">
                                ...
                                <div class="option-field-body">
                                    ...
                                    <p class="description"><span class="dashicons dashicons-warning wpshop-warning-color"></span> Проверьте работу сайта после установки параметра</p>
                                    <p class="description wpshop-red-color"><small>* Редко, но случается, что на хостинге не работает (из-за характеристик сервера, php) - напишите в поддержку</small></p>
                                </div>
                            </div><!--.option-field-->
                        ...
                        <div id="clearfy_seo" class="wpshop-tab-in js-wpshop-tab-item">
                            ...
                            <div class="option-field">
                                ...
                                <div class="option-field-body">
                                    ...
                                    <p class="description"><strong>Clearfy:</strong> Ставит редирект с http на https.</p>
                            ...
                            <div class="option-field">
                                <label class="option-field-label" for="remove_last_item_breadcrumb_yoast">
                                    Убрать дублирование названия в хлебных крошках WP SEO by Yoast
                                    <div class="clearfy-recommend">Рекомендовано</div>
                                </label>
                                <div class="option-field-body">
                        ...
                        <div id="clearfy_security" class="wpshop-tab-in js-wpshop-tab-item">
                            ...
                            <div class="option-field">
                                ...
                                <div class="option-field-body">
                                    ...
                                    <p class="description"><strong>Clearfy:</strong> Удаляет версии у стилей</p>
                                </div>
                            </div><!--.option-field-->
                            ...
                            <div class="option-field">
                                ...
                                <div class="option-field-body">
                                    ...
                                    <p class="description"><strong>Clearfy:</strong> Удаляет версии у скриптов</p>
                                </div>
                            </div><!--.option-field-->
    ...
    public function display_widgets() {
        ...
        <div class="wpshop-widget">
            Версия плагина: <?php echo $this->version; ?>
        </div>
