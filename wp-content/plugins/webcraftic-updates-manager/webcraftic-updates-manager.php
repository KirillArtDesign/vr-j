...
$wupm_plugin_info = [
	...
	'load_factory_modules' => [
		...
		['libs/factory/templates', 'factory_templates_103', 'all'],
		['libs/factory/adverts', 'factory_adverts_124', 'admin']
	]
];

$wupm_compatibility = new Wbcr_Factory446_Requirements(__FILE__, array_merge($wupm_plugin_info, [
