							...
							<div class="resume">
								...
								<div class="resume__content">
									...
									<div class="resume__textblock">
										...
										<div class="resume__text">
											<?php echo get_post_meta ($post->ID,'on_resume_navik',true); ?>
									<!--	<ul>
									...
									<div class="resume__textblock">
										...
										<div class="resume__text">
											<?php echo get_post_meta ($post->ID,'on_resume_obraz',true); ?>
										</div>
									</div>									
									<div class="resume__textblock">
										<div class="resume__title">
										...
										<?php 					
												// $xopit = json_decode(trim(str_replace("\\", "",  get_post_meta ($post->ID,'on_resume_mesta_works',true))), true);
												$xopit = unserialize (get_post_meta ($post->ID,'on_resume_mesta_works',true));
										?>
									...
									<div class="resume__textblock">
										...
										<div class="resume__text">											
											Гражданство: <? echo get_post_meta ($post->ID,'on_resume_grazdanstvo',true); ?><br>
											Разрешение на работу: <? echo get_post_meta ($post->ID,'on_resume_razreshenie',true); ?><br>
											Желательное время в пути до работы: <? echo get_post_meta ($post->ID,'on_resume_time',true); ?>
										</div>
									</div>	
								</div>
							</div>