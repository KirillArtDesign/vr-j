						...
						//		$args['meta_compare']='LIKE';
							...
							<?php endif; ?>
								...
								<div class="filter filter_vacancy">
									...
									<div class="filter__form">
										<div class="filter__vacancy-cell filter__vacancy-cell_text filter__vacancy-cell_prof">
											<input type="text" name="on-name" class="filter__input filter__input_vacancy" value="<? echo $_GET['on-name']; ?>" placeholder="Резюме">
										</div>
								...
								<div class="sort">
									...
									<a href="<?php echo get_permalink('411');?>" class="strong">Резюме</a>
								</div>
							<!--vacancy list-->
							<div class="job">
								...
								<?php
									if ( have_posts() ) : ?>
										...
										while ( have_posts() ) : the_post();
												...
												$img_adds = get_the_post_thumbnail_url($post->ID, 'full' );
												...
												$print_city = get_post_meta($post->ID,'on_resume_city',true);
